...
docker-clean:
	$(DOCKER) rmi ghcr.io/vfeeg-development/vfeeg-backend:latest

docker: docker-clean
	$(DOCKER) build -t ghcr.io/vfeeg-development/vfeeg-backend:latest .

push: docker
	$(DOCKER) push ghcr.io/vfeeg-development/vfeeg-backend:latest
