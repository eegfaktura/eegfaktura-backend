-- Revert ZVT: Views auf den vorherigen Stand, Spalten entfernen.
...
ALTER TABLE base.tariff
    DROP COLUMN IF EXISTS "useTimeTariff",
    DROP COLUMN IF EXISTS "timeTariff1Active",
    DROP COLUMN IF EXISTS "timeTariff1Name",
    DROP COLUMN IF EXISTS "timeTariff1From",
    DROP COLUMN IF EXISTS "timeTariff1To",
    DROP COLUMN IF EXISTS "timeTariff1CentPerKWh",
    DROP COLUMN IF EXISTS "timeTariff2Active",
    DROP COLUMN IF EXISTS "timeTariff2Name",
    DROP COLUMN IF EXISTS "timeTariff2From",
    DROP COLUMN IF EXISTS "timeTariff2To",
    DROP COLUMN IF EXISTS "timeTariff2CentPerKWh";
